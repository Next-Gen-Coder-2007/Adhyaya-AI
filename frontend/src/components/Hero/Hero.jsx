  ...
  return (
    <section className="py-20 lg:py-32 relative">
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(to right, rgba(255, 215, 0, 0.5) 1px, transparent 1px),
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link
            to="/login"
            className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-yellow-500 to-yellow-700 text-black rounded-xl font-semibold text-base sm:text-lg shadow-lg cursor-pointer transition-all hover:scale-105"
          >
            Get Started Free
          </Link>
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 border-2 border-yellow-600 text-yellow-400 rounded-xl font-semibold text-base sm:text-lg hover:bg-yellow-900/20 transition-all hover:scale-105"
          >
            Explore Features
          </button>
        </div>
