  ...
  return (
    <section className="relative pt-12 pb-20 lg:pt-20 lg:pb-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8 z-10">
        {/* Top Tag Pill */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-semibold text-amber-400 backdrop-blur-md shadow-lg">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-normal pt-2">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-2">
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-bold uppercase tracking-wider text-white transition-all cursor-pointer flex items-center justify-center gap-2"
          >
        ...
        <div className="pt-10 max-w-5xl mx-auto relative">
          {/* Badge 1 - Top Left */}
          <div className="hidden lg:flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-zinc-950/95 border border-amber-500/30 shadow-2xl backdrop-blur-xl absolute -top-4 -left-8 z-20 animate-float-slow pointer-events-none">
          ...
          {/* Badge 2 - Top Right */}
          <div
            className="hidden lg:flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-zinc-950/95 border border-amber-500/30 shadow-2xl backdrop-blur-xl absolute -top-6 -right-8 z-20 animate-float-slow pointer-events-none"
          ...
          {/* Studio Preview Card */}
          <div className="relative rounded-3xl p-2 sm:p-3 bg-gradient-to-b from-white/15 via-white/5 to-transparent border border-white/10 shadow-2xl backdrop-blur-2xl">
            {/* Top Mock Window Bar */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-4 bg-zinc-950/90 rounded-b-2xl text-left">
              ...
              <div className="lg:col-span-5 space-y-3">
                ...
                <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 space-y-2">
                  ...
                  <div className="p-2 rounded-lg bg-amber-500/15 border border-amber-500/40 text-[11px] text-amber-300 flex items-center gap-2">
